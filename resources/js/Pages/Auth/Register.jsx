          ...
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            ...
            <div className="hidden lg:relative lg:block lg:p-10">
              ...
              <p className="mt-4 leading-relaxed text-white/90">
                Bienvenido a nuestra plataforma de delivery de restaurantes.
                Inicia sesión o regístrate para pedir deliverys de platos de
                restaurantes de alta calidad. Regístrate hoy mismo.
              </p>
            </div>
          </section>
            ...
            <div className="max-w-xl lg:max-w-3xl">
              <div className="relative -mt-16 block lg:hidden">
                ...
                <p className="mt-4 leading-relaxed text-gray-500">
                  Bienvenido a nuestra plataforma de delivery de restaurantes.
                  Inicia sesión o regístrate para pedir deliverys de platos de
                  restaurantes de alta calidad. <br />
              ...
              <form onSubmit={submit} className="mt-8 grid grid-cols-6 gap-6">
                <Link
                  className="hidden lg:block w-40 col-span-6 m-auto "
                  href="/"
                >
                  <img src={delivery_logo} alt="" />
                </Link>
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  ...
                  >
                    ...
                    <span className="relative inline-block border-2 border-current px-6 py-2 md:px-8 md:py-3  text-sm font-bold uppercase tracking-widest w-full text-center">
                      Crear Cuenta
                    </span>
                  </button>
