  ...
  return (
    <>
      <DashboardLayout>
        ...
        <p className=" text-center mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl text-gray-300">
        ...
        <div className="mt-10 flex flex-col md:flex-row justify-center">
          <form
            ...
            className="flex flex-col gap-4 md:min-w-[350px] md:max-w-[500px] mx-auto md:m-0 w-full"
          >
            <div>
              <TextInput
                id="nombre"
              ...
              />
              {errors.nombre && (
                <div className="text-red-400 text-sm">{errors.nombre}</div>
              )}
            </div>
            <div>
              <label
            ...
            <div>
              ...
              />
              {errors.precio && (
                <div className="text-red-400 text-sm">{errors.precio}</div>
              )}
            </div>
            <div>
              <select
            ...
            <button
              ...
              href="/download"
            >
              <span className="absolute inset-y-0 left-0 w-[2px] bg-[#ec7c6a] transition-all group-hover:w-full group-active:bg-indigo-500"></span>
              <span className="relative text-sm font-medium text-gray-300 transition-colors group-hover:text-white">
                Añadir Plato
              </span>
            </button>
          </form>
            ...
            <img
              src={
                data.foto
                  ...
                  : "https://us.123rf.com/450wm/piren/piren1703/piren170301324/74444935-el-icono-de-la-c%C3%A1mara-en-un-fondo-negro.jpg?ver=6"
              }
              className="w-60 h-60 lg:w-80 lg:h-80 object-cover  shadow-2xl rounded-full mx-auto md:mr-0 mb-10"
            />
            <button
              onClick={handleClickRef}
              className=" w-fit self-center flex gap-2 bg-[#1F1D2B] shadow-lg p-2 items-center rounded-md text-gray-300 font-semibold hover:scale-105 transition-all"
            >
